...
class DeviceAllocator {
 public:
  ...
  // free should not have size argument, but like pooled allocator we need size to find the right
  // pool in order not to maintain a map from ptr to size (introduce searching and locking
